...
export default function HomeContent() {
  ...
  // Static images (previously in state)
  const doorImage = '/images/presentationsite/door-style-gad10.jpg'; 
  const accessoryImage = '/images/studioAccessories/accessory-handle-style-10.jpg';
