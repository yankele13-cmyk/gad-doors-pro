  ...
  const getWhatsAppMessage = () => {
    const messages = {
      fr: {
        ...
        '/doors': 'Bonjour ! Je suis intéressé par vos portes d\'intérieur. Pouvez-vous me donner plus d\'informations ?',
        '/accessories': 'Bonjour ! J\'aimerais avoir des informations sur vos accessoires et poignées.',
        '/contact': 'Bonjour ! Je souhaite vous contacter concernant vos produits.',
